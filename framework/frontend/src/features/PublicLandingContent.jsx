    ...
    <div className="plc-root">
      ...
      <section className="plc-hero">
        <div className="plc-hero-inner">
          ...
          <span className="plc-hero-overline">Platform Monitoring MBG</span>

          <h1 className="plc-hero-title">
            Pantau Distribusi<br />Makan Bergizi Gratis
          </h1>

          <p className="plc-hero-sub">
            Platform transparan untuk memantau distribusi, menu, dan kualitas
          ...
          <div className="plc-stats">
            {STATS.map((s) => (
              <div key={s.label} className="plc-stat-item">
                ...
                <span className="plc-stat-label">{s.label}</span>
              </div>
            ))}
          </div>
      ...
      <section className="plc-features">
        <div className="plc-features-inner">
          ...
          <h2 className="plc-features-title">Semua yang kamu butuhkan dalam satu tempat</h2>
          <p className="plc-features-sub">
            Dari pencarian sekolah hingga pemantauan distribusi harian —
            gratis dan terbuka untuk seluruh masyarakat.
          </p>

          <div className="plc-features-grid">
            {FEATURES.map(({ key, icon, name, desc, badge }) => (
              <div key={key} className="plc-feature-card">
                <div className="plc-feature-icon">{icon}</div>
                <h3 className="plc-feature-name">{name}</h3>
                <p className="plc-feature-desc">{desc}</p>
                {badge && <span className="plc-feature-badge">{badge}</span>}
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="plc-footer-inner">
          <div className="plc-footer-left">
            ...
            <p className="plc-footer-tagline">
              Platform monitoring transparan untuk program Makan Bergizi Gratis Indonesia.
            </p>
          </div>
          <div className="plc-footer-right">
            ...
            <p className="plc-footer-copy">© 2026 HaloMBG. Dibuat untuk rakyat Indonesia.</p>
          </div>
        </div>
      </footer>
